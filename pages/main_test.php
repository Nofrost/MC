...
<div id="question_test">
	...
	<span class="tr cat <?php if($lang != 'cat') echo 'hide'; ?>">
		<div>Senyali les situaciones on les respostes siguin afirmatives</div><br>
		<div id="ord_list">
			<ol>
		...
		<div>Per finalitzar el test <a id="button_click" href="home.php?page=Contact&lang=<?php echo $lang;?>">cliqui aqu&iacute;</a></div>
	</span>
	<span class="tr es <?php if($lang != 'es') echo 'hide'; ?>">
		<div>Se&ntilde;ale las situaciones donde las respuestas sean afirmativas</div><br>
		<div id="ord_list">
			<ol>
		...
		<div>Para finalizar el test <a id="button_click" href="home.php?page=Contact&lang=<?php echo $lang;?>">clica aquí</a></div>
	</span>
	<span class="tr en <?php if($lang != 'en') echo 'hide'; ?>">
		<div>Check the situations where the answer is affirmative</div><br>
		<div id="ord_list">
			<ol>
		...
		<div><a id="button_click" href="home.php?page=Contact&lang=<?php echo $lang;?>">Click here</a> to finish the test</div>
	</span>
	<span class="tr it <?php if($lang != 'it') echo 'hide'; ?>">
		<div>Situazioni di segnale in cui le risposte sono affermative</div><br>
		<div id="ord_list">
			<ol>
		...
		<div><a id="button_click" href="home.php?page=Contact&lang=<?php echo $lang;?>">Clicca qui</a> per terminare il test</div>
	</span>
</div>
